"""Inference pipeline for the Attack Type Random Forest model.

By default this:
- Loads the latest saved Random Forest model artifact
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Run inference for Attack Type using the Random Forest model."
    )
    parser.add_argument(
        "--split",
    ...
    parser.add_argument(
        "--model-path",
        default=None,
        help="Optional path to a specific attack_type_random_forest_model.joblib.",
    )
    parser.add_argument(
        "--limit",
        type=int,
...
def run_inference(
    *,
    ...
    model_prefix = "attack_type_random_forest"
    ...
    artifact_prefix = f"attack_type_random_forest_{split}"
